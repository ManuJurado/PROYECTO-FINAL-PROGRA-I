...
extern Medidas medidasConsola; // Declaración de la variable global para la consola
extern Medidas medidasCuadro;  // Declaración de la variable global para el recuadro
