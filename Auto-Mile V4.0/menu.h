...
int leerLimite(char *digitos, int max);
int leerLimiteNumeros(char *digitos, int max);
...
int escribeCuadro(int x, int y, int (*funcion)(), char texto[], int cant);
int menuCrearUsuario(int x, int y, int *dni, char contra[]);
...
void menuAlquilerUsuario(int x, int y,int dni);
